...
- ---
:lock: :infinity: **stage** - represents the candidate release code that is currently being promoted thru to production
- ---
:lock_with_ink_pen: :stopwatch: ***release branch*** - associated to sprint teams release efforts as per the program increment
...
:unlock: :hourglass_flowing_sand: ***feature branch*** each branch represent a single effort to resolve an Agile issue, and is an unrestrained workspace for the developers
   ...
   **Naming convention**: \<_optional issue type_>-VSAPI-\<Jira Issue Number\>-\<optional text\>
   
      example: VSAPI-29881-SHarris   
      or
      example: bugfix/VSAPI-29881-SHarris
---
 **Branch Naming Optional Components**
 - **Issue types**:
   - bugfix, feature, task
---
...
**Naming convention**: **\<Jira Key>** **\<Jira summary\>** or **\<Summary or the effort\>**
    ...
    Example:
    `VSAPI-123456 Enhanced the automation deployment for PPD`
